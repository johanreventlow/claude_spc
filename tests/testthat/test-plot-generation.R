...
test_that("basic ggplot SPC chart generation works", {
  ...
  plot <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ...
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::geom_line(ggplot2::aes(y = ucl), color = "#dc3545", linetype = "dashed", linewidth = 0.8) +
    ggplot2::geom_line(ggplot2::aes(y = lcl), color = "#dc3545", linetype = "dashed", linewidth = 0.8) +
    ggplot2::labs(title = "Test SPC Chart", x = "", y = "Proportion") +
...
test_that("target line addition works correctly", {
  ...
  plot_with_target <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::geom_hline(
    ...
    ggplot2::labs(title = "SPC Chart with Target", x = "", y = "Proportion") +
    ggplot2::theme_minimal()
...
test_that("phase separation lines work correctly", {
  ...
  plot_with_phases <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::geom_vline(
    ...
    ggplot2::labs(title = "SPC Chart with Phase Change", x = "", y = "Proportion") +
    ggplot2::theme_minimal()
...
test_that("comment annotations work correctly", {
  ...
  plot_with_comments <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
...
test_that("chart scaling and axis formatting work", {
  ...
  plot_percentage <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ...
    ggplot2::labs(title = "SPC Chart with Custom Scaling") +
    ggplot2::theme_minimal()
  ...
  plot_dates <- ggplot2::ggplot(date_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ...
    ggplot2::labs(title = "SPC Chart with Date Axis") +
    ggplot2::theme_minimal()
...
test_that("theme and styling work correctly", {
  ...
  plot_styled <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::labs(
...
test_that("different chart types render correctly", {
  ...
  p_chart <- ggplot2::ggplot(p_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::geom_line(ggplot2::aes(y = ucl), color = "#dc3545", linetype = "dashed", linewidth = 0.8) +
    ...
    ggplot2::labs(title = "P-Chart", y = "Proportion") +
    ggplot2::theme_minimal()
  ...
  run_chart <- ggplot2::ggplot(run_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::scale_y_continuous(limits = c(80, 100), labels = scales::label_percent(scale = 1)) +
    ggplot2::labs(title = "Run Chart", y = "Percentage") +
    ggplot2::theme_minimal()
  ...
  i_chart <- ggplot2::ggplot(i_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
    ggplot2::geom_line(ggplot2::aes(y = ucl), color = "#dc3545", linetype = "dashed", linewidth = 0.8) +
    ggplot2::geom_line(ggplot2::aes(y = lcl), color = "#dc3545", linetype = "dashed", linewidth = 0.8) +
    ggplot2::labs(title = "I-Chart", y = "Individual Values") +
    ggplot2::theme_minimal()
...
test_that("error handling in plot generation works", {
  ...
  sparse_plot <- ggplot2::ggplot(valid_sparse_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line() +
    ggplot2::geom_point()
...
test_that("plot accessibility and usability features work", {
  ...
  legend_plot <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x)) +
    ggplot2::geom_line(ggplot2::aes(y = y, color = "Observed Values"), linewidth = 1.5) +
    ggplot2::geom_line(ggplot2::aes(y = cl, color = "Center Line"), linewidth = 2) +
    ggplot2::geom_line(ggplot2::aes(y = ucl, color = "Upper Control Limit"), linetype = "dashed", linewidth = 1.5) +
    ggplot2::geom_line(ggplot2::aes(y = lcl, color = "Lower Control Limit"), linetype = "dashed", linewidth = 1.5) +
...
test_that("plot export and sizing work correctly", {
  ...
  export_plot <- ggplot2::ggplot(qic_data, ggplot2::aes(x = x, y = y)) +
    ggplot2::geom_line(color = "#6c757d", linewidth = 1) +
    ggplot2::geom_point(size = 2, color = "#6c757d") +
    ggplot2::geom_line(ggplot2::aes(y = cl), color = "#007bff", linetype = "solid", linewidth = 1) +
